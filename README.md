...
2026.6.19-
         ...
         按照时间顺序划分训练集、验证集和测试集：70、0.15和0.15；

         使用随机森林算法训练模型；

         定义评价函数；

         计算模型的四项性能参数：mae、rmse、r2、mape；
...
2026.8.24-
         ...
         更新基准模型，以训练集平均值作为预测，评估模型性能。
         
2026.8.27-
         在这个文件中02_feature_engineering_baseline

         更新线性回归模型、随机树模型

         更新三种模型的RMSE MAE R2 MAPE 结果数据
